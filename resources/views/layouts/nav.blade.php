...
<div id="navigation">
    <div id="headerLinks">
        <ul><li style="z-index:81;" class="first" id="nav_home"  >
            ...
            <li style="z-index:74;" class="last" id="nav_contact"  ><a class="@if (Request::path() === 'contact') selected @endif" href="{{ URL::to('contact') }}" target="_self"><span></span>Contact US</a></li>
            <li style="z-index:78;" id="nav_events"  ><a class="@if (Request::path() === 'events') selected @endif" href="{{ URL::to('events') }}" target="_self"><span></span>Events</a></li>
            ...
            <li style="z-index:74;" id="nav_event-photos"  ><a class="@if (Request::path() === 'photos') selected @endif" href="{{ URL::to('event-photos') }}" target="_self"><span></span>Event Photos</a></li>
            ...
            <li style="z-index:77;" id="nav_unplugged"  ><a class="@if (Request::path() === 'unplugged') selected @endif" href="{{ URL::to('unplugged') }}" target="_self"><span></span>Unplugged</a></li>
